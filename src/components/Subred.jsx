...
export default function Subred({ip, setIp}) {
  ...
  return (
    <div className='w-full md:w-1/2 bg-zinc-100 md:h-full gap-3 shadow-lg p-10 space-y-3 flex flex-col justify-between'>
        <h2 className='text-sky-600 font-bold text-lg md:text-xl lg:text-2xl text-center'>Crea subredes</h2>
        <form onSubmit={e => handleCrearSubredes(e)} className="space-y-3">
            <div className="space-y-1">
                <label htmlFor="mascara_subred" className='text-sky-600 font-bold md:text-lg lg:text-xl text-center block'>Máscara de las subredes</label>
                ...
                <select className="m-auto block text-base md:text-lg text-center" id="mascara_subred" value={valueMask} onChange={e => setValueMask(e.target.value)}>
            ...
            <div className="flex justify-between w-full sm:w-2/3 md:w-full lg:w-2/3 m-auto"> 
                <div>
                    <label htmlFor="mascara_host" className='text-sky-600 font-bold text-sm md:text-base text-center'>Host por subred</label>
                    <select className="m-auto block text-base md:text-lg text-center" id="mascara_host" value={valueMask} onChange={e => setValueMask(e.target.value)}>
                ...
                <div>
                    <label htmlFor="mascara_subredes" className='text-sky-600 font-bold text-sm md:text-base text-center'>Subredes</label>
                    <select className="m-auto block text-base md:text-lg text-center" id="mascara_subredes" value={valueMask} onChange={e => setValueMask(e.target.value)}>
